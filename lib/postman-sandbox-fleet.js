...
/**
 * @typedef {Object} customSDKInstance
 *
...
/**
 * Returns the custom SDK instances for `request` and `response`
 *
 ...
 * @return {customSDKInstance} - Request and response instances based on context.
 */
...
class PostmanSandboxFleet {
    ...
    getContext (templateName, callback) {
        ...
        new PostmanSandbox().initialize({
            ...
            this.fleet.set(templateName, context);
