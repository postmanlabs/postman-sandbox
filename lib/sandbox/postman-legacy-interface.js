...
module.exports = {
    ...
    setup (scope, execution, console) {
        ...
        if (execution.response) {
            ...
            execution.response && execution.response.headers && execution.response.headers.each(function (header) {
             ...
             * @type {Number}
             */
            globalvars.responseCode = execution.response && _.isFunction(execution.response.details) ?
                _.clone(execution.response.details()) : {
                    code: NaN,
                    name: E,
                    details: E
                };
        ...
        const postmanLegacy = new (execution.response ?
