...
module.exports = {
     ...
     * @param  {Execution} execution
     *
     * @todo Move getAssertionObject function from pmapi-setup-runner.js to a common place
     * and reuse it here
     */
    raiseAssertionEvents: function (execution, pmapi, tests) {
        var assertionIndex = pmapi.test.index(),
