var _ = require('lodash'),
    ...
    getAssertionObject = require('./assertion-object').getAssertionObject,

    EXECUTION_ASSERTION_EVENT = 'execution.assertions',
    EXECUTION_ASSERTION_EVENT_BASE = 'execution.assertions.',
    ...
    scope.exec(code, function (err) {
        ...
        if (!_.isEmpty(execution.tests)) {
            assertions = _.map(execution.tests, function (value, key) {
                return getAssertionObject(key, false, !value);
            });
