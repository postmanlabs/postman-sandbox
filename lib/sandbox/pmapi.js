...
Postman = function Postman (bridge, execution, onRequest) {
    ...
    iterationData = new VariableScope(execution.data);
    ...
    execution.variables.addLayer(iterationData.values);
    execution.variables.addLayer(execution.environment.values);
    execution.variables.addLayer(execution.collectionVariables.values);
    execution.variables.addLayer(execution.globals.values);
...
chai.use(require('chai-postman')(sdk));
