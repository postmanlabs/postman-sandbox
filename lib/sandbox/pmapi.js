                    ...
                    return new Promise(function (resolve, reject) {
                        ...
                        onRequest(PostmanRequest.isRequest(req) ? req : (new PostmanRequest(req)),
                            function (err, resp, his) {
                                ...
                                // Only HTTP response and not execution.ResponseClass
                                // because sendRequest only works with HTTP endpoints
                ...
                return new Promise(function (resolve, reject) {
                    ...
                    onRunRequest(requestId, options || {},
                        function (err, resp) {
                            ...
                            const Response = execution.ResponseClass || PostmanResponse;

                            resolve(Response.isResponse(resp) ? resp : new Response(resp));
                        });
                });
            }
        },
