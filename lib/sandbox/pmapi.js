                ...
                return new Promise(function (resolve, reject) {
                    ...
                    onRunRequest(requestId, options || {},
                        function (err, resp) {
                            ...
                            if (resp.type === 'http-request') {
                                // TODO: Update this to support multi-protocol responses and not just HTTP
                                resolve(PostmanResponse.isResponse(resp.data) ?
                                    resp.data : (new PostmanResponse(resp.data)));
                            }
                            else {
                                resolve(resp.data);
                            }
