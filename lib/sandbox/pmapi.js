 ...
 * @param {Function} datasets - datasets interface function, called as datasets(datasetId) returning a handle
...
function Postman (execution,
    ...
    _assignDefinedReadonly(this, /** @lends Postman.prototype */ {
        ...
        */
        ...
        /**
         * @typedef {Object} DatasetStaleDatasource
         * @property {string} name - Name of the datasource that could not be refreshed.
         * @property {string} reason - Human-readable reason it is stale.
         */

        /**
         * Result of a dataset view or ad-hoc query execution.
         *
         * @typedef {Object} DatasetQueryResult
         * @property {string[]} columns - Ordered column names.
         * @property {AsyncIterable<Object>} rows - Single-pass async iterable of result rows.
         *   Iterate with `for await (const row of result.rows)`. Once exhausted it yields nothing.
         * @property {DatasetStaleDatasource[]} [staleDatasources] -
         *   Datasources whose underlying file or database could not be refreshed.
         ...
         *
         * @function
         * @name DatasetHandle#executeView
         * @param {string} viewId - View ID or name as defined in the dataset YAML.
         * @param {string[]} [params] - Optional parameter overrides for parameterized views.
         * @returns {Promise<DatasetQueryResult>}
         */
         ...
         *
         * @function
         * @name DatasetHandle#executeQuery
         * @param {string} sql - SQL query string. `?` placeholders bind to `params` in order.
         * @param {string[]} [params] - Optional parameter values for `?` placeholders.
         * @returns {Promise<DatasetQueryResult>}
         */
