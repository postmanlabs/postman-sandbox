...
Postman = function Postman (bridge, execution, onRequest) {
    ...
    _assignDefinedReadonly(this, /** @lends Postman.prototype */ {
         ...
         * @type {VariableScope}
         */
        variables: new VariableScope(execution.variables, [iterationData.values, execution.environment.values,
            execution.collectionVariables.values, execution.globals.values]),
