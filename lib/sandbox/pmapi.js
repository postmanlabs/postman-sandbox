                ...
                return new Promise(function (resolve, reject) {
                    ...
                    onRunRequest(requestId, options || {},
                        function (err, resp, context) {
                            ...
                            let ResponseClass = execution.getProtocolMetadata && context && context.responseType ?
                                // 'grpc-request' -> 'grpc' etc
                                execution.getProtocolMetadata(context.responseType.split(/[:-]/)[0])?.Response :
                                null;

                            if (!ResponseClass) {
                                ResponseClass = PostmanResponse;
                            }
