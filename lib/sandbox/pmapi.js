...
Postman = function Postman (bridge, execution, onRequest, cookieStore) {
    ...
    _assignDefinedReadonly(this, /** @lends Postman.prototype */ {
        ...
        visualiser: {
             ...
             * @param {Object} options.handlebarsOptions - hanadlebars options to use while compiling template
             */
            set: function (template, options) {
                execution.return.visualiser = {
                    template: template,
                    options: options
                };
            },
             ...
             */
            clear: function () {
                execution.return.visualiser = undefined;
            }
        }
    });
