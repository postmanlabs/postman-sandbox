...
function Postman (execution,
    ...
    _assignDefinedReadonly(this, /** @lends Postman.prototype */ {
        ...
        */
        ...
        /**
         * Access a dataset by ID. Returns a handle with methods to interact with the dataset.
         *
         * @param {string} datasetId - The dataset ID
         * @returns {Object} Dataset handle with addView, executeView, and executeQuery methods.
         *   executeView/executeQuery resolve to { columns, rows, staleDatasources? } where rows is a single-pass async iterable.
         */
        datasets: datasets,
