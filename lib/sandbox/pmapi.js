...
Postman = function Postman (bridge, execution, onRequest, cookieStore) {
    ...
    execution.cookies && (execution.cookies.jar = function (options) {
        return new CookieJar(cookieStore, Object.assign({looseMode: true}, options));
    });
    ...
    // bind pm.visualiser functions to execution instance
    _.forEach(this.visualiser, function (value, key) {
        typeof value === 'function' && (this.visualiser[key] = value.bind(execution));
    }.bind(this));
