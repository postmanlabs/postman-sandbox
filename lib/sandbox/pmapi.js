...
Postman = function Postman (bridge, execution, onRequest) {
    ...
    _assignDefinedReadonly(this, /** @lends Postman.prototype */ {
        ...
        variables: new VariableScope(execution._variables, [iterationData.values, execution.environment.values, execution.collectionVariables.values, execution.globals.values]),
