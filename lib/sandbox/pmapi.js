 ...
 * @param {Function} onSkipReq - callback to execute when pm.execution.skipRequest() called
 ...
 * @param {Function} onRunReq - callback to execute when pm.execution.runRequest is encountered in the script
 * @param {Function} requireFn - requireFn
 * @param {Object} [options] - options
 * @param {Array.<String>} [options.disabledAPIs] - list of disabled APIs
 */
function Postman (execution, onRequest, onSkipReq, onAssertion, cookieStore, vault, onRunReq, requireFn, options = {}) {
