    ...
    _assignDefinedReadonly(this, /** @lends Postman.prototype */ {
        ...
        */
        ...
        execution: /** @lends Execution */ {
             ...
             * @param {{ variables: Record<string, string | number | boolean> | undefined }} options - Options,
             *  can include variable specifications and overrides
             * @returns {Promise<Response | null>} - Promise that resolves to a PostmanCollection.Response
             * instance or null
             */
