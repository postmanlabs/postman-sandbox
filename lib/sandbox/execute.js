var _ = require('lodash'),
    ...
    EXECUTION_COOKIE_STORE_EVENT_BASE = 'execution.cookieStore.',
...
module.exports = function (bridge, glob) {
    ...
    bridge.on('execute', function (id, event, context, options) {
        ...
        var executionEventName = EXECUTION_RESULT_EVENT_BASE + id,
            ...
            cookieStoreEventName = EXECUTION_COOKIE_STORE_EVENT_BASE + id,
        ...
        // handle cookieStore event from outside sandbox
        bridge.on(cookieStoreEventName, function (id, err, res) {
            timers.clearEvent(id, err, res);
        });
