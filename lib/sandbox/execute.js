...
module.exports = function (bridge, glob) {
    ...
    bridge.once('initialize', async (initOptions) => {
        ...
        let { template, templates, chaiPlugin } = initializationOptions;
        ...
        const availableTemplates = templates || (template ? { _default: template } : {}),
        ...
        promises.push(chaiPlugin && _.isString(chaiPlugin) ? execTemplate(chaiPlugin) : Promise.resolve(null));
