...
module.exports = function (bridge, glob) {
    ...
    bridge.on('execute', function (id, event, context, options) {
        ...
        // inject function to send request
        // @todo this needs to go inside PM API
        scope.set('sendRequest', function (request, callback) {
        ...
        executeContext(scope, code, execution,
            (new PostmanConsole(bridge, options.cursor, options.debug && glob.console)), timers);
    });
};
